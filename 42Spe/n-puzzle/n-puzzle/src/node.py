...
class Node:
	...
	def createChildrenNodes(self, solutionGrid: List[int], gridSize: int) -> List['Node']:
		"""
		Generate and return a list of child nodes by moving the empty tile (0) in all possible directions.
		...
		Returns:
			List[Node]: A list of new nodes generated by moving the empty tile.
		"""
		newNodes: List['Node'] = []
